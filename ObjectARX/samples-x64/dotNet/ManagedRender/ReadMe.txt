...
3. This folder exists: 
	C:/Temp
4. This file exists:
	C:/Temp/background.jpg.  You may copy the background.jpg file in the Render sample folder to the C:/Temp folder.
 
 
Steps to run:

0. Load the ManagedRender.dll into AutoCAD.

1. The following command sequence is recommended:
	1.1  Run ObjsToRender command.
	1.2  Check the cube properties especially the Material property
	1.3  Run ListRenderSettings command.
	1.4  Run SetRenderSettings command.
	1.5  Run ListRenderSettings command again.
	1.6  Run AddLights command.
	1.7  Run Zoom Extents command.
	1.8  Use Sun Properties palette to check the sun of the current view.
	1.9  Run AddSunAndBackground command.
